...
/*
  ...
  //   * tables that store types other than char <--check
  ...
  // =======================================================  
    std::cout << std::endl;
    Table<int> test1(1,1,1);
    test1.pop_back_column();
    test1.print();
    std::cout << "test 1 complete";
    
    std::cout<< std::endl;
    Table<std::string> test2(4,5,"cat");
    test2.print();
    std::cout << std::endl;
    std::cout << "test 2 complete" << std::endl;
    
    Table<std::string> another_test2(test2);
    another_test2.print();
    
    Table<int> test3(2,2,2);
    
    test1 = test3;
    test1.print();
    
    
    Table<int> *test4 = new Table<int>(3,4,5);
    delete test4;
    */
