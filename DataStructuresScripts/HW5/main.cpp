...
void StudentTests() {
	//Testing when trying to ship/separate an emtpy train.
	TrainCar* testcase1_engines = NULL;
	TrainCar* testcase1_freight = NULL;
	TrainCar* testcase1_engines2 = NULL;
	TrainCar* testcase1_engines3 = NULL;
	ShipFreight(testcase1_engines, testcase1_freight, 60, 12);
	Separate(testcase1_engines, testcase1_engines2, testcase1_engines3);
	PrintTrain(testcase1_engines);

	//Testing when there is one car and one engine.
	TrainCar* testcase2_engines = NULL;
	TrainCar* testcase2_freight = NULL;
	TrainCar* testcase2_engines2 = NULL;
	TrainCar* testcase2_engines3 = NULL;
	PushBack(testcase2_engines, TrainCar::MakeEngine());

	
	PushBack(testcase2_freight, TrainCar::MakePassengerCar());
